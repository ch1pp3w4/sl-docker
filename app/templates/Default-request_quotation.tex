...
\begin{tabularx}{\textwidth}{@{}lXrlrr@{}}
  \textbf{Number} & \textbf{Descripcion} & \textbf{Cant.} &
    \textbf{Unidad} & \textbf{Precio} & \textbf{Extended} \\
...
\textbf{S O L I C I T U D de C O T I Z A C I O N}
\hfill

\vspace{1cm}

\begin{tabularx}{\textwidth}{*{6}{|X}|} \hline
  \textbf{SDC \#} & \textbf{Fecha} & \textbf{Requerido para} & \textbf{Contacto} & \textbf{Punto de Embarque} & \textbf{Via de Envio} \\ [0.5ex]
  \hline
...
Favor de indicar precio y fecha de entrega para las siguientes partidas:

\vspace{1cm}

\begin{tabularx}{\textwidth}{@{}lXrllrr@{}}
  \textbf{Number} & \textbf{Descripcion} & \textbf{Cant.} & &
  \textbf{Fecha Entrega} & \textbf{Unidad Precio} & \textbf{Importe} \\
<%foreach number%>
