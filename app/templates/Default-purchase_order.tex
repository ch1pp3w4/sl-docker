...
\begin{tabularx}{\textwidth}{@{}lXrlrr@{}}
  \textbf{Number} & \textbf{Descripcion} & \textbf{Cant.} &
    \textbf{Unidad} & \textbf{Precio} & \textbf{Importe} \\
...
\textbf{P E D I D O} \parbox{0.3cm}{\hfill} \textbf{C O M P R A}
\hfill

\vspace{1cm}
\begin{tabularx}{\textwidth}{*{6}{|X}|} \hline
  \textbf{Pedido \#} & \textbf{Fecha} & \textbf{Requerido para} & \textbf{Contacto} & \textbf{Punto de Embarque} & \textbf{Via de Envio} \\ [0.5ex]
  \hline
