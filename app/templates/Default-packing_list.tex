...
Partidas returned are subject to a 10\% restocking charge.
...
\begin{tabularx}{\textwidth}{@{}rlXllrrl@{}}
  \textbf{Partida} & \textbf{Number} & \textbf{Descripcion} & \textbf{Numero de Serie} & & \textbf{Cant.} & \textbf{Ship} & \\
<%end pagebreak%>
