...
\textbf{C R E D I T O \hspace{0.2cm} C O M E R C I A L}

\vspace{1cm}

\begin{tabularx}{\textwidth}{*{8}{|X}|} \hline
  \textbf{Factura \#} & \textbf{Fecha de Factura} & \textbf{Pedido \#} & \textbf{Vendedor}
  <%if shippingpoint%>
...
\begin{tabularx}{\textwidth}{@{}rlXlrlrrr@{}}
  \textbf{Partida} & \textbf{Number} & \textbf{Descripcion} & \textbf{Cant.} &
    \textbf{Unidad} & \textbf{Precio} & \textbf{Importe} \\ [0.5em]
<%foreach number%>
